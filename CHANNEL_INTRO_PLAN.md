# Channel Intro Plan — The Unplanned Stack
...
It plays on the channel homepage, to someone who has never seen you. It answers
three things in order: **who is this, why should I trust them, and what do I get
if I stay.**

Target runtime: **4–5 minutes.** A channel trailer that runs past six is a video
nobody finishes.
...
The canvas sits in `canvas/` next to the LLM series canvases because that is
where the toolchain lives, not because it belongs to the series. If the channel
ever gets its own repo, `excalidraw_kit.py` and this canvas move together.
