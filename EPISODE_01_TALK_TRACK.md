...
Canvas: `canvas/episode_01_bigram.excalidraw` (28 scenes)
...
- **Mechanical scenes** — 08 to 10, 16 to 19, 21 to 23. Arithmetic on screen.
  Say the numbers precisely and slowly; work them on camera. Precision is the
  product here.
- **Conceptual scenes** — 01 to 07, 11 to 15, 20, 24 to 28. Conviction, not
...
**One take per scene**, not one take per video. 28 short takes are recoverable.
...
3. It is a seed you harvest in scene 26. Trained on `anna` and `ava`, every
...
- **NUMBERS:** Ours is the letters in the name list plus two boundary tokens. 26 letters + `<END>` = 27 things that can come next. Flag that number; it returns in scene 19.
...
why the matrix is asymmetric in scene 09 — `<START>` is somewhere you can be,
...
## 09 · The count matrix  ·  *mechanical*
...
## 10 · Counts → probabilities  ·  *mechanical*
...
## 16 · Why the probabilities multiply  ·  *mechanical*
...
## 17 · Logarithms, and why we need them  ·  *mechanical*
...
## 18 · Negative log-likelihood  ·  *mechanical*
...
## 23 · k is a dial, and it costs you  ·  *mechanical*
...
## 26 · Limitation 2: locally fine, globally nonsense
