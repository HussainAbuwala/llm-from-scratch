...
# =============================================================== 03 tiny data
sc = cv.scene("03 · Make the problem tiny")
sc.heading("Tokens are characters. Context is one character.",
           "Both are deliberate simplifications. Both get replaced later in the series.")
sc.add(box(80, 220, 340, 340, bg=BG_GRAY))
sc.add(text(110, 245, "names.txt", 22, CODE, GRAY))
sc.add(text(110, 300, "anna\nava\namelia\nnoah\nliam\n...", 34, CODE))
sc.add(text(90, 576, "one line = one independent example", 20, HAND, RED))
sc.add(arrow(440, 380, 560, 380))
sc.add(text(450, 320, "zoom in", 20, HAND, GRAY))
sc.add(text(590, 300, "\"anna\"", 44, CODE))
